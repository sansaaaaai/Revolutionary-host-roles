...
例: `welcome:この部屋はRevolutionaryHostRolesを使用しています。`
...
| [タイムシーフ](#TimeThiefタイムシーフ)                               | [シェリフ](#Sheriffシェリフ)                                | [テロリスト](#Terroristテロリスト)   |                      |             |
| [ヴァンパイア](#Vampireヴァンパイア)                                 | [スニッチ](#Snitchスニッチ)                                 | [シュレディンガーの猫](#SchrodingerCatシュレディンガーの猫)|               |
| [ウォーロック](#Warlockウォーロック)                                 | [スピードブースター](#SpeedBoosterスピードブースター)       |                                                             |           |
| [魔女](#Witch魔女)                                                   | [トラッパー](#Trapperトラッパー)                            |                                                             |           |
| [マフィア](#Mafiaマフィア)                                           | [インセンダー](#Insenderインセンダー)                                                            |                                                             |           |
| [トリッカー](#Trickerトリッカー)                                 |                                                             |                                                             |           |
| [リローダー](#Reloaderリローダー)                 |                                                             |                                                             |           |
...
独自の能力、トリックでプレイヤーを消すことができる。<br>
シェイプシフトを行うことで、トリックキルのON OFFを切り替えられる。<br>
#### 設定
| 設定名               |                   |
| -------------------- | ----------------- |
| クールダウン(s)
...
独自の能力、リロードを行うことで設定値までキルクールダウンを引き下げることができる。<br>
設定により回数、クールタイムを変更可能。 <br>
...
ベイトとは異なり、インセンダーはキルされると"自分自身"でミーティングを展開します。
...
### Jackalfellow/ジャッカルフェロー

陣営 : 第三（ジャッカル）<br>
判定 : クルー<br>

クルー判定であるが、ジャッカルの味方をします。 <br>
※いわゆるマッドメイトのジャッカル陣営版　<br>
ベントが使え、タスクはない。設定により能力を1つ付与することができる。<br>
マッドスニッチ・ウォッチャー・ドクター・シーアから選ぶことができる <br>
### 設定
| 設定名                   |
| ------------------------ |
|ベントクールダウン
...
クルーメイトのメイヤー以外に付与される属性です。
勝利条件はノーマルのマッドメイトと同じ。

### Anti teleporter/アンチテレポーター

ミーティング終了後、ミーティングが開始した地点から行動を開始できる。
